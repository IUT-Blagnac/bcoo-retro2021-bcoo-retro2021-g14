...
image::https://cdn.discordapp.com/attachments/845346140936208407/845346192615407646/1-interface-gestion-d-un-serveur.png[alt="1-interface-gestion-d-un-serveur.png",width=1290,height=699]
