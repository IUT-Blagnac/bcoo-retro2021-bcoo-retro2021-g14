...
image:https://github.com/IUT-Blagnac/bcoo-retro2021-bcoo-retro2021-g14/blob/master/projet/maquettes%20écrans/1-interface%20gestion%20d'un%20serveur.png[alt"gestionserv"]
